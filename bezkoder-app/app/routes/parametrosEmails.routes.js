module.exports = (app) => {
  ...
  parametrosEmailsRouter.post(
    "/",
    requireAuth,
    parametrosEmailsController.create
  );

  // Recuperar todos los registros de ParametrosEmails
  parametrosEmailsRouter.get(
    "/",
    requireAuth,
    parametrosEmailsController.findAll
  );
  ...
  parametrosEmailsRouter.get(
    "/:id",
    requireAuth,
    parametrosEmailsController.findOne
  );

  // Actualizar un registro de ParametrosEmails con id
  parametrosEmailsRouter.put(
    "/:id",
    requireAuth,
    parametrosEmailsController.update
  );

  // Eliminar un registro de ParametrosEmails con id
  parametrosEmailsRouter.delete(
    "/:id",
    requireAuth,
    parametrosEmailsController.delete
  );

  parametrosEmailsRouter.post(
    "/",
    requireAuth,
    parametrosEmailsController.createOrUpdate
  );
  parametrosEmailsRouter.put(
    "/:id",
    requireAuth,
