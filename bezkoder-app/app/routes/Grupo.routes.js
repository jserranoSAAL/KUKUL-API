...
module.exports = app => {
    ...
    grupoRouter.post("/", requireAuth, grupoController.create);

    // Ruta para recuperar todos los Gastos
    grupoRouter.get("/", requireAuth, grupoController.findAll);

    // Ruta para recuperar un único Gasto con id
    grupoRouter.get("/:id", requireAuth, grupoController.findOne);

    // Ruta para actualizar un Gasto con id
    grupoRouter.put("/:id", requireAuth, grupoController.update);

    // Ruta para eliminar un Gasto con id
    grupoRouter.delete("/:id", requireAuth, grupoController.delete);

    // Ruta para buscar Grupos por nombre
    grupoRouter.get("/search/:nombre", requireAuth, grupoController.findByName);
