module.exports = app => {
    ...
    agenciasDeViajeInformacionRouter.post("/", requireAuth, agenciasDeViajeInformacionController.create);

    // Recuperar todas las Agencias de Viaje
    agenciasDeViajeInformacionRouter.get("/", requireAuth, agenciasDeViajeInformacionController.findAll);
