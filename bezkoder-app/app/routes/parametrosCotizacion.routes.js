module.exports = (app) => {
  ...
  parametrosCotizacionRouter.post(
    "/",
    requireAuth,
    parametrosCotizacionController.create
  );

  // Recuperar todos los registros de ParametrosCotizacion
  parametrosCotizacionRouter.get(
    "/",
    requireAuth,
    parametrosCotizacionController.findAll
  );
  ...
  parametrosCotizacionRouter.get(
    "/:id",
    requireAuth,
    parametrosCotizacionController.findOne
  );

  // Actualizar un registro de ParametrosCotizacion con id
  parametrosCotizacionRouter.put(
    "/:id",
    requireAuth,
    parametrosCotizacionController.update
  );

  // Eliminar un registro de ParametrosCotizacion con id
  parametrosCotizacionRouter.delete(
    "/:id",
    requireAuth,
    parametrosCotizacionController.delete
  );

  parametrosCotizacionRouter.post(
    "/",
    requireAuth,
    parametrosCotizacionController.createOrUpdate
  );
  parametrosCotizacionRouter.put(
    "/:id",
    requireAuth,
